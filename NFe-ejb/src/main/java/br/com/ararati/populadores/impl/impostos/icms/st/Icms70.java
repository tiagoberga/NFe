...
public class Icms70 implements IImposto {
    ...
    public void verificaImposto(DetalhamentoProdutoServico item, ICMS icms) throws NFeException {
        if (item.getCsticms().equals(NFeTipoSituacaoTributariaICMS.COD70)) {
            icms70 = new ICMS70();
            icms70.setOrig(item.getOrig());
            icms70.setCST(item.getCsticms() != null ? item.getCsticms().getCodigo() : null);
            icms70.setModBC(item.getModbc() != null ? item.getModbc().getCodigo() : null);
            icms70.setModBCST(item.getModbcst().getCodigo());
            ...
            icms70.setPRedBC(item.getPredbc() != null ? item.getPredbc().toString() : null);
            ...
            icms70.setPRedBCST(item.getPredbcst() != null ? item.getPredbcst().toString() : null);
