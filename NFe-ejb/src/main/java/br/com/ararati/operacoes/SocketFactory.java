...
public class SocketFactory implements ProtocolSocketFactory {
    ...
    public SocketFactory(X509Certificate certificate, PrivateKey privateKey) {
    ...
    public Socket createSocket(String host, int port, InetAddress localAddress, int localPort, HttpConnectionParams params) throws IOException, UnknownHostException, ConnectTimeoutException {
        if (params == null) {
            throw new IllegalArgumentException("HttpConnectionParams: Parâmetros não podem ser nulos.");
        }
